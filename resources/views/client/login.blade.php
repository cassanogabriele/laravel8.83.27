<!DOCTYPE html>
	...
	<head>
		<title>GC MARKET - Se connecter</title>
		<meta charset="UTF-8">
	...
	<body>		
		<div class="limiter">
			<div class="container-login100" style="background-image: url('frontend/login/images/background-connexion.jpg');">
				<div class="wrap-login100">
					...
					<form action="{{ route('acceder_compte') }}" class="login100-form validate-form" method="POST">
